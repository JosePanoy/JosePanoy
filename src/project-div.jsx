...
function SideProjects() {
    ...
    const fadeInFromBottom = (delay) => useSpring({
        opacity: inView ? 1 : 0,
...
>
    <div className="project-details">
        ...
        <a href="http://christiananthony-photos.vercel.app/" className="project-link" target="_blank" rel="noopener noreferrer">
            Visit <FaExternalLinkAlt />
        </a>
    </div>
</animated.div>
...
>
    <div className="project-details">
        ...
        <a href="http://pfh-seven.vercel.app/" className="project-link" target="_blank" rel="noopener noreferrer">
            Visit <FaExternalLinkAlt />
        </a>
    </div>
</animated.div>
...
>
    <div className="project-details">
        ...
        <a href="http://footflick.vercel.app/" className="project-link" target="_blank" rel="noopener noreferrer">
            Visit <FaExternalLinkAlt />
        </a>
    </div>
</animated.div>
...
>
    <div className="project-details">
        ...
        <p className="project-progress">Progress: 100%</p>
        <a href="https://servicepage-one.vercel.app/" className="project-link" target="_blank" rel="noopener noreferrer">
            Visit <FaExternalLinkAlt />
        </a>
    </div>
</animated.div>
